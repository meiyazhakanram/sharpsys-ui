...
const UserStories = ({ review, customSlide }: { review: Stories, customSlide: any }) => {
  ...
  return (
    ...
    <div className={`flex ${customSlide === 'aboutus' ? 'flex-row w-2/5 m-auto' : 'justify-center items-center'}`}><Image className={`rounded-full ${customSlide === 'aboutus' ? 'px-4 h-48' : 'w-44 h-44'} `} src={image} alt={header}/> </div>
